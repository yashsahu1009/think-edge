...
import SupportIcon from "./Help";

// Separated CompaniesSection component
  ...
  return (
    <div className="w-full">
        ...
        <div className="relative z-10 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-8">
            <div className="text-center">
              ...
              <h3 className="count text-3xl font-semibold" data-target="6000000">0</h3>
            ...
            <div className="text-center">
              <p className="text-4xl">&#128279;</p>
              <h3 className="count text-3xl font-semibold" data-target="100000">0</h3>
      ...
      <section className="placement bg-white text-center py-16 px-4">
        ...
        <button
          className="btn bg-indigo-600 text-white py-3 px-6 mt-6 rounded hover:bg-indigo-700"
          onClick={() => navigate("/sigma-course")}
        >
          Explore More &raquo;
        </button>
