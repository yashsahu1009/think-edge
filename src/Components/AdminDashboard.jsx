...
const API_BASE_URL = "http://192.168.29.224:8081/api/admin/AllCourse";
const ADD_COURSE_URL = "http://192.168.29.224:8081/api/admin/addcourse";
const DELETE_COURSE_URL = "http://192.168.29.224:8081/api/admin/removeCourse";
const EDIT_COURSE_URL = "http://192.168.29.224:8081/api/admin/updateCourseWithoutimage";
const VIDEO_COURSE_URL = "http://192.168.29.224:8081/api/addVideo";
